...
- `varldsrymden-anfaller/assets/ui/` - generated alien-biomechanical console and button artwork.
- `varldsrymden-anfaller/assets/fonts/` - local Oxanium display font and its SIL Open Font License.
